create procedure [sp_MSupd_PersonBusinessEntityContact]
		@c1 int = NULL,
		@c2 int = NULL,
		@c3 int = NULL,
...
update [Person].[BusinessEntityContact] set
		...
		[ContactTypeID] = case substring(@bitmap,1,1) & 4 when 4 then @c3 else [ContactTypeID] end,
    ...
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[Person].[BusinessEntityContact]', @param2=@primarykey_text, @param3=13233 
			End
			Else
