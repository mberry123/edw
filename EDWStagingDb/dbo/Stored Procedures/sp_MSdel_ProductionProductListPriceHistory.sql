create procedure [sp_MSdel_ProductionProductListPriceHistory]
		@pkc1 int,
		@pkc2 datetime
as
begin  
    ...
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[Production].[ProductListPriceHistory]', @param2=@primarykey_text, @param3=13234 
			End
			Else
