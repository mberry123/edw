create procedure [sp_MSdel_ProductionProductProductPhoto]
		@pkc1 int,
		@pkc2 int
as
begin  
    ...
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[Production].[ProductProductPhoto]', @param2=@primarykey_text, @param3=13234 
			End
			Else
