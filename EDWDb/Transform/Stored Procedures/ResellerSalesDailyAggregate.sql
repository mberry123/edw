...
CREATE PROCEDURE [Transform].[ResellerSalesDailyAggregate]
AS
BEGIN
...
GO
EXECUTE sp_addextendedproperty @name = N'DailyUpdateExecutionOrder', @value = N'1004', @level0type = N'SCHEMA', @level0name = N'Transform', @level1type = N'PROCEDURE', @level1name = N'ResellerSalesDailyAggregate';
