...
CREATE PROCEDURE [Transform].[InternetSalesWeeklyAggregate]
AS
BEGIN
...
GO
EXECUTE sp_addextendedproperty @name = N'DailyUpdateExecutionOrder', @value = N'1002', @level0type = N'SCHEMA', @level0name = N'Transform', @level1type = N'PROCEDURE', @level1name = N'InternetSalesWeeklyAggregate';
